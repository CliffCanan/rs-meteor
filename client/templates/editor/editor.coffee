...
class @Editor
  ...
  constructor: (options) ->
    _.extend(@, options)
    EditorCache.register(@)
  editorId: (_id) ->
    EditorCache.editorId(@family, _id)
  editorKey: (_id, key) ->
    EditorCache.editorKey(@family, _id, key)
  ...
  startEditing: (_id, property) ->
    ...
    EditorCache.add(@editorId(_id), "is-edited", {family: @family, _id: _id})
  ...
  stopEditing: (_id) ->
    ...
    EditorCache.remove(@editorId(_id), "is-edited")
  ...
  remove: (_id) ->
    ...
    EditorCache.remove(@editorId(_id), "is-edited")
Editor::debouncedSaveProperty = _.debounce(Editor::saveProperty, 500)
Editor::debouncedSaveObject = _.debounce(Editor::saveObject, 500)
